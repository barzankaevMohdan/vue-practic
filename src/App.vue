<template>
  <div class="container">
    <form class="card" @submit.prevent="submitHandler">
      ...
      <div class="form-control" :class="errors.name ? 'invalid' : ''">
      ...
      <div class="form-checkbox">
      <span class="label">Правила сервиса</span>
        <div class="checkbox">
          <label><input type="checkbox" v-model="agree"/> Согласен с условиями</label>
        </div>
      </div>
